 ...
 * @see Modules/User/app/Http/Controllers/PermissionController.php:27
 ...
 * @see Modules/User/app/Http/Controllers/PermissionController.php:94
 * @route '/api/v1/permissions'
 */
 ...
 * @see Modules/User/app/Http/Controllers/PermissionController.php:340
 ...
 * @see Modules/User/app/Http/Controllers/PermissionController.php:174
 * @route '/api/v1/permissions/{permission}'
 */
 ...
 * @route '/api/v1/permissions/{permission}'
 */
        updateForm.patch = (args: { permission: string | number } | [permission: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @see Modules/User/app/Http/Controllers/PermissionController.php:388
 * @route '/api/v1/permissions/{permission}'
 */
