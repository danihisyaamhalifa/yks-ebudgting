...
approve.definition = {
    methods: ["post"],
    url: '/api/v1/budget-request-approvals/{id}/approve',
} satisfies RouteDefinition<["post"]>
...
reject.definition = {
    methods: ["post"],
    url: '/api/v1/budget-request-approvals/{id}/reject',
} satisfies RouteDefinition<["post"]>
...
returned.definition = {
    methods: ["post"],
    url: '/api/v1/budget-request-approvals/{id}/returned',
} satisfies RouteDefinition<["post"]>
...
const BudgetRequestController = { index, store, show, update, destroy, submit, resubmit, approvals, approvalHistory, approve, reject, returned }
