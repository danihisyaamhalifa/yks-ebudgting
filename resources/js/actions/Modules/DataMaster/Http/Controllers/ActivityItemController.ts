...
/**
* @see \Modules\DataMaster\Http\Controllers\ActivityItemController::forSelect
 * @see Modules/DataMaster/app/Http/Controllers/ActivityItemController.php:51
 * @route '/api/v1/select/activity-items'
 */
...
forSelect.definition = {
    methods: ["get","head"],
    url: '/api/v1/select/activity-items',
...
const ActivityItemController = { forSelect, index, store, show, update, destroy }

export default ActivityItemController