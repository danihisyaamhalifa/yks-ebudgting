...
/**
* @see \Modules\DataMaster\Http\Controllers\UnitController::forSelect
 * @see Modules/DataMaster/app/Http/Controllers/UnitController.php:44
 * @route '/api/v1/select/units'
 */
...
const UnitController = { forSelect, index, store, show, update, destroy }
