...
/**
* @see \Modules\DataMaster\Http\Controllers\FundSourceController::forSelect
 * @see Modules/DataMaster/app/Http/Controllers/FundSourceController.php:42
 * @route '/api/v1/select/fund-sources'
 */
...
forSelect.definition = {
    methods: ["get","head"],
    url: '/api/v1/select/fund-sources',
...
const FundSourceController = { forSelect, index, store, show, update, destroy }

export default FundSourceController