...
/**
* @see \Modules\DataMaster\Http\Controllers\ActivityController::forSelect
 * @see Modules/DataMaster/app/Http/Controllers/ActivityController.php:45
 * @route '/api/v1/select/activities'
 */
...
const ActivityController = { forSelect, index, store, show, update, destroy }
