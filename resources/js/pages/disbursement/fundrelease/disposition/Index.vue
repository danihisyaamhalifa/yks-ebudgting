...
const canCreate = computed(
    () => user.hasPermission('create disposisi_pencairan') ?? false,
);
...
const viewFundRelease = (fundRelease: BudgetFundRelease) => {
    router.visit(`/disposisi-pencairan/${fundRelease.id}/view`);
};

const editFundRelease = (fundRelease: BudgetFundRelease) => {
    router.visit(`/disposisi-pencairan/${fundRelease.id}/edit`);
};
...
const goToCreatePage = () => {
    router.visit('/disposisi-pencairan/input');
};
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">
                        Daftar disposisi pencairan yang diajukan
                    </p>
                </div>
            ...
            <DataTable
                ...
                show-pagination
                show-page-info
                empty-message="Data disposisi pencairan tidak ditemukan"
                server-side
