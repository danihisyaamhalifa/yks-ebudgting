...
interface BudgetActivity {
    ...
    isExpanded?: boolean; // Add this property for toggle state
}
...
// Toggle function for activity details
    ...
    try {
        ...
        switch (verificationData.status) {
            case 'approved':
                ...
                break;
            case 'returned':
                endpoint = `/api/v1/budget-request-approvals/${currentApproval.id}/returned`;
                break;
            case 'rejected':
                    ...
                    <div class="mb-8 border-t pt-6">
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                <div
                                    class="cursor-pointer border-b bg-gray-50 px-4 py-3 transition-colors hover:bg-gray-100"
